...
export const metadata: Metadata = {
  title: 'Membership | Redstone Area Lakes Association',
  description: 'Join the Redstone Area Lakes Association (RALA) — membership dues, benefits and how to register.',
}
