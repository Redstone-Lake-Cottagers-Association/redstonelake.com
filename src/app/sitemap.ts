...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[0]['changeFrequency'] }[] = [
    ...
    { path: '/community-connection', priority: 0.5, changeFrequency: 'yearly' },
    { path: '/nature-watch', priority: 0.5, changeFrequency: 'yearly' },
    { path: '/private-buoys', priority: 0.5, changeFrequency: 'yearly' },
    { path: '/make-a-difference', priority: 0.5, changeFrequency: 'yearly' },
